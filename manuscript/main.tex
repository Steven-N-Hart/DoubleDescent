...
Calibration assessment in survival models can be decomposed into distinct components \citep{crowson2016assessing}. Calibration-in-the-large captures systematic over- or under-prediction of event rates. The calibration slope measures whether risk stratification is appropriately spread across the prediction range \citep{royston2013external}. The integrated calibration index provides a summary measure of calibration error across the risk distribution \citep{austin2020graphical}. This decomposition enables precise characterization of how and where prognostic models fail.

...
\begin{itemize}
\item \textbf{METABRIC} \citep{curtis2012genomic}: approximately 1,980
breast cancer patients with $\sim$58\% events and 9 clinical features.

\item \textbf{SUPPORT} \citep{knaus1995support}: approximately 8,870
critically ill patients with $\sim$68\% events and 14 clinical features.
\end{itemize}
...
On METABRIC, the calibration-discrimination decoupling reproduces clearly:
IBS saturates at approximately 0.385 while C-index continues to vary across
